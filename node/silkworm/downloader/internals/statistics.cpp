...
std::ostream& operator<<(std::ostream& os, const Download_Statistics& stats) {
    ...
    os << std::setfill('_') << std::right
       << "elapsed(m)=" << std::setw(7) << duration_cast<minutes>(stats.elapsed()).count() << ", "
       << "req=" << std::setw(7) << stats.requested_items << ", "
       << "rec=" << std::setw(7) << stats.received_items << " (" << perc_received << "%) -> "
       << "acc=" << std::setw(7) << stats.accepted_items << " (" << perc_accepted << "%), "
       << "rej=" << std::setw(7) << stats.rejected_items() << " (" << perc_rejected << "%";
